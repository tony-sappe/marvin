...
| **GitHub CLI** | `gh skill install tony-sappe/marvin --all` (non-interactive default: Copilot, project scope) | Discovers `skills/*/SKILL.md` via [agentskills.io](https://agentskills.io) / `gh skill` | Same snippet |
