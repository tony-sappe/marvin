...
- High blast means auth, data, money, untrusted input, production path, or concurrency. That work needs a trust-boundary challenge: assets, boundary, one abuse or failure scenario, control, evidence. Procedure: `../thinking-tools.md#threat-modeling`.
