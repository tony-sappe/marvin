---
name: dont-panic
description: Set Don't Panic intensity and remind the skill map. Use when the user says dont-panic, Don't Panic, lite, full, ultra, or asks how to use this collection. Do not use as a substitute for bound-the-ask, smallest-trusted, prove-it, find-the-fault, or subtract on the actual work.
license: MIT
metadata:
...
2. **smallest-trusted** — design shape and new parts; ladder; stop early.
...
Vibe coding is allowed. Obvious one-file outcomes may go straight to `smallest-trusted` under lite/full.
