...
Default: inspection if the user has not named a cut. Surgical if they pointed at one thing. Plan if the area is broad. Hard mode only when asked for aggressive simplification.
